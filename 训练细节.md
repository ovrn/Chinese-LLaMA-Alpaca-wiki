...
```
其中llama_tokenizer_dir指向存放原版LLaMA tokenizer的目录；chinese_sp_model_file指向用sentencepiece训练的中文词表文件。我们所使用的在中文通用语料上训练好的20K中文词表也一并放出，可以在[scripts/chinese_sp.model](https://github.com/ymcui/Chinese-LLaMA-Alpaca/tree/main/scripts/chinese_sp.model)下载。
